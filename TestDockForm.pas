...
uses
  ...
  Vcl.Controls,
  Vcl.StdCtrls,
  DockForm, Vcl.ToolWin, Vcl.ActnMan, Vcl.ActnCtrls, System.Actions,
  ...
  System.RegularExpressions,Vcl.Themes;
...
begin
  if FCurrentEnd >= Length(FBookText) then
    Exit;
...
begin
  ...
  try
    ...
    begin
      if SameText(ExtractFileExt(Zip.FileNames[I]), '.xhtml') or
         SameText(ExtractFileExt(Zip.FileNames[I]), '.html') then
      begin
        Zip.Read(I, S, H);
